                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-1">
                    <div>
                        <div className="flex items-center gap-3 mb-1">
                            ...
                            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Lab Patient Directory</h1>
                        </div>
                        <p className="text-slate-500 text-sm ml-12">Register and manage patient demographics for lab testing.</p>
                    </div>
